...
public class MapaResponse {
    ...
    public MapaResponse(MapaModelo modelo) {
        this.id_mapa = modelo.getId_mapa();
        this.nombre = modelo.getNombre();
        this.energia_in = modelo.getEnergia_in();
        this.x_inicio = modelo.getX_inicio();
        this.y_inicio = modelo.getY_inicio();
        this.descripcion = modelo.getDescripcion();
        this.x_tam = modelo.getX_tam();
        this.y_tam = modelo.getY_tam();
    }
