...
import com.example.store.service.SensorService;
...
public class SensorController {
    ...
    @Autowired
    SensorService servicio;
    
    @GetMapping("/sensores/{id}")
    public ResponseEntity<SensorResponse> get_habilidad(@PathVariable("id") Long sessionId) {
        try {
    ...
    public ResponseEntity<Long> add_habilidad(@RequestBody SensorRequest peticion){
        try {
    ...
    public ResponseEntity alter_habilidad(@PathVariable("id") Long Id,@RequestBody SensorRequest peticion){
        try {
    ...
    @GetMapping("/sensores")
    public ResponseEntity<List<SensorResponse>> get_habilidades() {
        try {
