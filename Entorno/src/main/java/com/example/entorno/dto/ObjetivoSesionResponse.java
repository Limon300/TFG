...
public class ObjetivoSesionResponse {
    ...
    public ObjetivoSesionResponse(ObjetivoModelo modelo,List<Long> agentes) {
        this.id_obj = modelo.getId_objetivo();
        this.id_obj_store = modelo.getId_objetivo_store();
        this.estatus = modelo.getEstatus();
        this.compartido = modelo.getCompartido();
        this.X = modelo.getX();
        this.Y = modelo.getY();
        this.agentes = agentes;
    }
