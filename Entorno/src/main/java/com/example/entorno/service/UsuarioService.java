...
public class UsuarioService {
    ...
    public Optional<Long> addToStore(UsuarioPostRequest peticion){
        String usrUrl = "http://"+store_adress+"/api/usuarios";
    ...
    public Optional<UsuarioResponse> getFromStore(Long id){
        String usrUrl = "http://"+store_adress+"/api/usuarios/" + id + "/login";
    ...
    public Optional<UsuariosModelo> getSesionUsuario(Long id){
